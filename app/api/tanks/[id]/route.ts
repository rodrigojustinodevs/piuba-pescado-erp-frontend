...
/**
 * GET /api/tanks/[id] - Busca um tanque por ID (proxy para backend)
 */
export async function GET(
  ...
  try {
    ...
    const apiResponse = await fetch(`${API_BASE_URL}/api/admin/tank/${id}`, {
      method: "GET",
      headers: {
...
/**
 * PUT /api/tanks/[id] - Atualiza um tanque (proxy para backend)
 */
...
/**
 * DELETE /api/tanks/[id] - Remove um tanque (proxy para backend)
 */
